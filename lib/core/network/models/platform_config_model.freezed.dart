...
@JsonKey(name: 'maintenance_mode') bool get maintenanceMode;@JsonKey(name: 'maintenance_message_fr') String? get maintenanceMessageFr;@JsonKey(name: 'maintenance_message_en') String? get maintenanceMessageEn;@JsonKey(name: 'active_cities') List<String> get activeCities;@JsonKey(name: 'default_city') String get defaultCity;@JsonKey(name: 'android_version') String? get androidVersion;@JsonKey(name: 'android_min_version') String? get androidMinVersion;@JsonKey(name: 'ios_version') String? get iosVersion;@JsonKey(name: 'ios_min_version') String? get iosMinVersion;@JsonKey(name: 'force_update') bool get forceUpdate;@JsonKey(name: 'update_url') String? get updateUrl;@JsonKey(name: 'ios_update_url') String? get iosUpdateUrl;@JsonKey(name: 'update_message_fr') String? get updateMessageFr;@JsonKey(name: 'update_message_en') String? get updateMessageEn;@JsonKey(name: 'support_phone') String? get supportPhone;@JsonKey(name: 'support_email') String? get supportEmail;@JsonKey(name: 'terms_url') String? get termsUrl;@JsonKey(name: 'privacy_url') String? get privacyUrl; List<String> get features; PaymentConfig? get payment; DeliveryConfig? get delivery; LoyaltyConfig? get loyalty;
...
@useResult
$Res call({
@JsonKey(name: 'maintenance_mode') bool maintenanceMode,@JsonKey(name: 'maintenance_message_fr') String? maintenanceMessageFr,@JsonKey(name: 'maintenance_message_en') String? maintenanceMessageEn,@JsonKey(name: 'active_cities') List<String> activeCities,@JsonKey(name: 'default_city') String defaultCity,@JsonKey(name: 'android_version') String? androidVersion,@JsonKey(name: 'android_min_version') String? androidMinVersion,@JsonKey(name: 'ios_version') String? iosVersion,@JsonKey(name: 'ios_min_version') String? iosMinVersion,@JsonKey(name: 'force_update') bool forceUpdate,@JsonKey(name: 'update_url') String? updateUrl,@JsonKey(name: 'ios_update_url') String? iosUpdateUrl,@JsonKey(name: 'update_message_fr') String? updateMessageFr,@JsonKey(name: 'update_message_en') String? updateMessageEn,@JsonKey(name: 'support_phone') String? supportPhone,@JsonKey(name: 'support_email') String? supportEmail,@JsonKey(name: 'terms_url') String? termsUrl,@JsonKey(name: 'privacy_url') String? privacyUrl, List<String> features, PaymentConfig? payment, DeliveryConfig? delivery, LoyaltyConfig? loyalty
});
...
/// Create a copy of PlatformConfigModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? maintenanceMode = null,Object? maintenanceMessageFr = freezed,Object? maintenanceMessageEn = freezed,Object? activeCities = null,Object? defaultCity = null,Object? androidVersion = freezed,Object? androidMinVersion = freezed,Object? iosVersion = freezed,Object? iosMinVersion = freezed,Object? forceUpdate = null,Object? updateUrl = freezed,Object? iosUpdateUrl = freezed,Object? updateMessageFr = freezed,Object? updateMessageEn = freezed,Object? supportPhone = freezed,Object? supportEmail = freezed,Object? termsUrl = freezed,Object? privacyUrl = freezed,Object? features = null,Object? payment = freezed,Object? delivery = freezed,Object? loyalty = freezed,}) {
...
as String?,androidMinVersion: freezed == androidMinVersion ? _self.androidMinVersion : androidMinVersion // ignore: cast_nullable_to_non_nullable
as String?,iosVersion: freezed == iosVersion ? _self.iosVersion : iosVersion // ignore: cast_nullable_to_non_nullable
as String?,iosMinVersion: freezed == iosMinVersion ? _self.iosMinVersion : iosMinVersion // ignore: cast_nullable_to_non_nullable
...
as String?,iosUpdateUrl: freezed == iosUpdateUrl ? _self.iosUpdateUrl : iosUpdateUrl // ignore: cast_nullable_to_non_nullable
as String?,updateMessageFr: freezed == updateMessageFr ? _self.updateMessageFr : updateMessageFr // ignore: cast_nullable_to_non_nullable
as String?,updateMessageEn: freezed == updateMessageEn ? _self.updateMessageEn : updateMessageEn // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _PlatformConfigModel() when $default != null:
return $default(_that.maintenanceMode,_that.maintenanceMessageFr,_that.maintenanceMessageEn,_that.activeCities,_that.defaultCity,_that.androidVersion,_that.androidMinVersion,_that.iosVersion,_that.iosMinVersion,_that.forceUpdate,_that.updateUrl,_that.iosUpdateUrl,_that.updateMessageFr,_that.updateMessageEn,_that.supportPhone,_that.supportEmail,_that.termsUrl,_that.privacyUrl,_that.features,_that.payment,_that.delivery,_that.loyalty);case _:
  return orElse();
...
class _PlatformConfigModel implements PlatformConfigModel {
  const _PlatformConfigModel({@JsonKey(name: 'maintenance_mode') this.maintenanceMode = false, @JsonKey(name: 'maintenance_message_fr') this.maintenanceMessageFr, @JsonKey(name: 'maintenance_message_en') this.maintenanceMessageEn, @JsonKey(name: 'active_cities') final  List<String> activeCities = const [], @JsonKey(name: 'default_city') this.defaultCity = 'douala', @JsonKey(name: 'android_version') this.androidVersion, @JsonKey(name: 'android_min_version') this.androidMinVersion, @JsonKey(name: 'ios_version') this.iosVersion, @JsonKey(name: 'ios_min_version') this.iosMinVersion, @JsonKey(name: 'force_update') this.forceUpdate = false, @JsonKey(name: 'update_url') this.updateUrl, @JsonKey(name: 'ios_update_url') this.iosUpdateUrl, @JsonKey(name: 'update_message_fr') this.updateMessageFr, @JsonKey(name: 'update_message_en') this.updateMessageEn, @JsonKey(name: 'support_phone') this.supportPhone, @JsonKey(name: 'support_email') this.supportEmail, @JsonKey(name: 'terms_url') this.termsUrl, @JsonKey(name: 'privacy_url') this.privacyUrl, final  List<String> features = const [], this.payment, this.delivery, this.loyalty}): _activeCities = activeCities,_features = features;
...
@override@JsonKey(name: 'android_min_version') final  String? androidMinVersion;
@override@JsonKey(name: 'ios_version') final  String? iosVersion;
@override@JsonKey(name: 'ios_min_version') final  String? iosMinVersion;
@override@JsonKey(name: 'force_update') final  bool forceUpdate;
@override@JsonKey(name: 'update_url') final  String? updateUrl;
@override@JsonKey(name: 'ios_update_url') final  String? iosUpdateUrl;
@override@JsonKey(name: 'update_message_fr') final  String? updateMessageFr;
@override@JsonKey(name: 'update_message_en') final  String? updateMessageEn;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,maintenanceMode,maintenanceMessageFr,maintenanceMessageEn,const DeepCollectionEquality().hash(_activeCities),defaultCity,androidVersion,androidMinVersion,iosVersion,iosMinVersion,forceUpdate,updateUrl,iosUpdateUrl,updateMessageFr,updateMessageEn,supportPhone,supportEmail,termsUrl,privacyUrl,const DeepCollectionEquality().hash(_features),payment,delivery,loyalty]);
