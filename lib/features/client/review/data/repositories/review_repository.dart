...
class ReviewRepository {
  ...
  Future<Either<AppError, List<ReviewModel>>> getRestaurantReviews(
    String restaurantId, {
    int page = 1,
  }) async {
    try {
  ...
  Future<Either<AppError, List<ReviewModel>>> getMyReviews({
    int page = 1,
  }) async {
    try {
  ...
  Future<Either<AppError, void>> createReview({
    ...
    try {
      ...
      return const Right(
        null,
      ); // Return Right to signify that it will be handled
    }
  }
}
