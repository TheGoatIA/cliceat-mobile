...
abstract class AuthEvent with _$AuthEvent {
  ...
  const factory AuthEvent.loginDelivery({
    required String phone,
    required String password,
  }) = _LoginDelivery;
  const factory AuthEvent.loginWithGoogle({required String token}) =
      _LoginWithGoogle;
  const factory AuthEvent.loginWithApple({required String token}) =
      _LoginWithApple;
