...
abstract class MissionState {
  ...
  T maybeWhen<T>({
    ...
    if (this is _Loaded && loaded != null) return loaded((this as _Loaded).missions);
    if (this is _Error && error != null) return error((this as _Error).message);
    if (this is _ActionSuccess && actionSuccess != null) return actionSuccess((this as _ActionSuccess).message);
    return orElse();
  }
}
